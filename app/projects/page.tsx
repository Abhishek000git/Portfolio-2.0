...
const featuredProjects = [
  ...
  },
  {
    ...
    description: "A blockchain-based project developed using Solidity that performs basic arithmetic operations (addition, subtraction, multiplication, division) securely and transparently on the Ethereum network.",
  ...
  },
  {
    ...
    description: "Designed and implemented a unique hashing algorithm to ensure data integrity and security, focusing on custom logic for optimized performance and collision resistance.",
...
const allProjects = [
  ...featuredProjects,
  {
    ...
    description: "Designed and developed a professional, responsive website for a business consulting firm, showcasing services, case studies, and client testimonials to establish a strong online presence and drive client engagement.",
  ...
  },
  {
    ...
    description: "Developed a simple two-player Tic-Tac-Toe game playable in the console, implementing core game logic, win condition checks, and a user-friendly interface using basic programming constructs.",
    image: "https://banner2.cleanpng.com/20180518/vru/kisspng-tic-tac-toe-oxo-chess-video-game-5aff53602d14e1.9166423615266824641847.jpg?height=300&width=400",
    technologies: ["Python"],
    github: "#",
  ...
  },
  {
    ...
    description: "Created a personal portfolio website to showcase projects, skills, and contact information using clean design principles and responsive layout for optimal viewing across devices.",
  ...
  return (
    <div className="pt-16 min-h-screen">
      <div className="container mx-auto px-4 py-12">
        ...
        >
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-orange-500 to-orange-600 bg-clip-text text-transparent">
            Projects
          </h1>
        ...
        >
          ...
          <div className="relative max-w-4xl mx-auto">
            <div className="overflow-hidden rounded-xl bg-gradient-to-br from-background to-background/50 border border-orange-500/20">
              <div
                    ...
                    <div className="grid md:grid-cols-2 gap-6 sm:gap-8 p-6 sm:p-8">
                      ...
                      <div className="flex flex-col justify-center">
                        ...
                        <div className="flex flex-wrap gap-2 mb-6">
                          {project.technologies.map((tech) => (
                            <Badge
                              key={tech}
                              variant="secondary"
                              className="bg-orange-500/10 text-orange-500 border-orange-500/20 text-xs sm:text-sm"
                            >
                              {tech}
                            </Badge>
                          ))}
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                          <Button asChild className="bg-gradient-to-r from-orange-500 to-orange-600 touch-manipulation">
                            <Link href={project.demo}>
                              <ExternalLink className="mr-2 h-4 w-4" />
                              Live Demo
                            </Link>
                          </Button>
                          <Button asChild variant="outline" className="border-orange-500/50 touch-manipulation">
            ...
            <Button
              variant="outline"
              size="icon"
              className="absolute left-2 sm:left-4 top-1/2 transform -translate-y-1/2 bg-background/80 backdrop-blur-sm border-orange-500/50 touch-manipulation"
              onClick={prevSlide}
            >
            ...
            <Button
              variant="outline"
              size="icon"
              className="absolute right-2 sm:right-4 top-1/2 transform -translate-y-1/2 bg-background/80 backdrop-blur-sm border-orange-500/50 touch-manipulation"
              onClick={nextSlide}
            >
        ...
        <section>
          ...
          <div ref={projectsAnimation.ref} className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {allProjects.map((project, index) => (
              <Card
                key={project.id}
                className={`group bg-gradient-to-br from-background to-background/50 border-orange-500/20 hover:border-orange-500/40 transition-all duration-500 hover:scale-105 touch-manipulation ${
                  ...
                  <div className="relative overflow-hidden">
                    ...
                    <div className="absolute bottom-4 left-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      <div className="flex gap-2">
                        <Button size="sm" asChild className="bg-orange-500 hover:bg-orange-600 touch-manipulation">
                          <Link href={project.demo || "#"}>
